...
try {
 ...
 if(await page.getByRole('button').count()!==5)throw new Error('Unexpected visible controls');
 ...
 const result={seeThroughDefault:'PASS',automaticMoon:'PASS',foregroundOpacity:'PASS',singleTypewriterFocus:'PASS',namedFrameSwitch:'PASS',date:new Date().toISOString(),mode:'immersive',visibleControls:5,frameParchmentWandAndTypewriter:'PASS'};
