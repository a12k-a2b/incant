...
await writeFile('dist/sw.js',`const CACHE=${JSON.stringify(cache)},FILES=${JSON.stringify(['/',...assets,'/manifest.webmanifest','/icon-192.png','/icon-512.png','/wizard-frame-v3.png','/wizard-frame-landscape.png','/wizard-typewriter.png'])};
